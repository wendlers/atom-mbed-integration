...
export default {
  ...
  activate(state) {
    ...
    this.mbedInstallerView.onRestart(
  ...
  showNewPrj() {
    ...
    this.mbedNewPrjView.createButton.focus();
  },
  ...
  install() {
    ...
    install_proc = new BufferedProcess({
        ...
        exit: (code) => {
            ...
            if(code) {
              this.mbedInstallerView.updateNote('Failed to install mbed toolchain!');
              this.mbedInstallerView.setInstallMode(false);
            }
            else {
              this.mbedInstallerView.updateNote('Successfully installed mbed toolchain! ' +
                                                'To finish installation, please restart atom.');
              this.setEnv();
              this.mbedInstallerView.setDone();
            }
            install_proc = null;
        }
    });
